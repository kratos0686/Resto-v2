...
const ARMapping: React.FC<ARMappingProps> = ({ project, onUpdate }) => {
  ...
  const [draggingItem, setDraggingItem] = useState<{ type: 'marker' | 'area_point' | 'current_area_point', id: string, pointIndex?: number } | null>(null);
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-10">
                ...
                <div className="absolute bottom-32 md:bottom-16 left-4 md:left-12 text-[10px] font-mono text-cyan-400 uppercase flex flex-col space-y-1 drop-shadow-[0_0_2px_rgba(0,0,0,0.8)] bg-slate-900/40 p-3 rounded-lg backdrop-blur-sm border border-brand-cyan/20 pointer-events-none">
                    ...
                    <span className="text-cyan-200">ENV: {project.waterCategory === 'Category 3' ? 'CRITICAL (CAT 3)' : project.waterCategory.toUpperCase()} | {project.lossClass.toUpperCase()}</span>
              ...
              <div className="absolute bottom-16 left-1/2 -translate-x-1/2 bg-slate-900/90 backdrop-blur-md border border-white/20 rounded-2xl px-2 py-2 flex items-center shadow-2xl z-30 shadow-brand-cyan/20 pointer-events-auto">
                <div className="flex items-center space-x-1">
                  <button 
                    onClick={(e) => { e.stopPropagation(); setInteractionMode('select'); setCurrentAreaPoints([]); }}
                  ...
                  <button 
                    onClick={(e) => { e.stopPropagation(); setInteractionMode('add_marker'); setCurrentAreaPoints([]); }}
                  ...
                  <button 
                    onClick={(e) => { e.stopPropagation(); setInteractionMode('draw_area'); setCurrentAreaPoints([]); setScalePoints([]); }}
                  ...
                  <button 
                    onClick={(e) => { e.stopPropagation(); setInteractionMode('set_scale'); setCurrentAreaPoints([]); setScalePoints([]); }}
