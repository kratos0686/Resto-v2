...
| Charts | Recharts `^2.15.4` in `package.json`; `index.html` importmap currently pins `2.10.3` for CDN/browser runtime |
| PDF | jsPDF 2.5 + html2canvas 1.4 |
| Icons | Lucide React `^0.469.0` in `package.json`; `index.html` importmap currently pins `0.303.0` for CDN/browser runtime |
