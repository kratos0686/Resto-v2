...
import { Bot, X, Mic, Send, VolumeX } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-slate-900 h-full shadow-2xl flex flex-col border-l border-white/10">
        <div className="p-4 border-b border-white/10 bg-slate-900/50 backdrop-blur-md flex justify-between items-center">
            <div className="flex items-center space-x-3">
                <div className={`p-2 rounded-xl ${isRecording ? 'bg-red-500/20 animate-pulse' : 'bg-brand-indigo/20'} border border-white/5`}>
                    {isRecording ? <Mic size={20} className="text-red-500" /> : <Bot size={20} className="text-brand-indigo" />}
                </div>
                <div>
